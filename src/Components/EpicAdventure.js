            ...
            <div className='background-picture'>
                ...
                <div>
                    <h2 className="h_84 section-heading">Get Everything you need for <br/>
                        ...
                        <p className='section-paragraph p_14'>Don't just play the game – own it. Morra Games Store empowers you to forge your own path with exclusive on-chain treasures for every adventurer.</p>
                </div>
                <GameSlider2/> 
                <Link to='' class="btn teal w-inline-block" style={{marginTop:'90px'}}> 
                    <div color-mode="light" class="btn_bg bg_dark-teal"></div>
                    <div className="p_16 text-white display"><span>Documentation</span><svg className="icon_20 margin-left-10" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
